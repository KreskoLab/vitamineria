	...
	>
		...
		>
			<ul
				...
				ref="menu"
				class="flex flex-col flex-wrap gap-x-16 content-start justify-between  absolute top-21 h-36 bg-white border-2 border-t-0 border-gray-600 z-50 transform -translate-x-1/2 left-1/2 w-[calc(100%+100px)] py-3 px-5 gap-y-4"
				@mouseleave="subcategoriesMenu.show = false"
			>
				<li 
